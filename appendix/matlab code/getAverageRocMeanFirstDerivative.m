...
function [x] = getAverageRocMeanFirstDerivative(dimensions, threshold, img1, img2, img3,operator)
...
label = strcat(operator,'M',int2str(dimensions),'T',int2str(threshold));
